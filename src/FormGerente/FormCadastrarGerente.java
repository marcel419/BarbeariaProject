 ...
 * @author jadil
 */
public class FormCadastrarGerente extends javax.swing.JFrame {

    /**
     * Creates new form FormCadastrarFuncionario
     */
    public FormCadastrarGerente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadastrarGerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadastrarGerente().setVisible(true);
            }
        });
    }
    ...
    private void JOptionPaneshowMessageDialog(FormCadastrarGerente aThis, String funcionario_cadastrado) {
